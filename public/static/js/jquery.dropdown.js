        ...
        _init: function (options) {
            ...
            this.$el.children('option').each(function () {
                var $this = $(this),
                    ...
                    classes = $this.attr('class'), selected = $this.attr('selected'), label = $this.text();
                if (val !== -1) {
                    optshtml += classes !== undefined ? '<li id="1" data-value="' + val + '"><span class="' + classes + '">' + label + '</span></li>' : '<li id="1" data-value="' + val + '"><span>' + label + '</span></li>';
                }
                if (selected) {
                    selectlabel = label;
                    value = val;
            ...
            if (!this.options.slidingIn) {
                this.opts.eq(this.optsCount - 1).css({
                    ...
                    transform: 'none'
                }).end().eq(this.optsCount - 3).css({top: this.options.stack ? 3 : 0, left: 0, transform: 'none'});
            }
